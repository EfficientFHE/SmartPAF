...
if __name__ == "__main__":
    ...
    if(args.data_collection):
        ...
        CT_train(sign_type = args.sign_type, degree=0, sign_scale = 0, scale_path= None, sign_nest_dict = nest_dict,batch_size = batch_size,
                 input_data_dirctory = args.working_directory , output_floder_suffix= "dynamic", epoch=40)
