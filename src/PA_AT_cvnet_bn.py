...
def train_network(input_data_dirctory, model, sign_type, valid_data_loader, train_data_loader  ,start_layer_name, max_layer_counter, lr_c, lr_w, CT_suffix = "dynamic"):
    sign_type = sign_type
    ...
    for key in sign_nest_dict:
        ...
        my_layer_CT = torch.load(input_data_dirctory+folder_name+file_name)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-st","--sign_type", type=str, default="a7", choices=["a7", "2f12g1", "f1g2", "f2g2", "f2g3", "polyfit"])
    ...
    lr_c = args.learning_rate = 1e-10
    lr_w = args.learning_rate = 1e-5
    ...
    train_network(model=model, sign_type = args.sign_type, start_layer_name = start_layer_name,
                  valid_data_loader = valid_data_loader, train_data_loader = train_data_loader,
                  max_layer_counter = args.max_counter, lr_c = lr_c, lr_w = lr_w, input_data_dirctory = args.working_directory, CT_suffix="polyfit_bn_o7")
